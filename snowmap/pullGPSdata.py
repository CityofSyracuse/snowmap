...
start_date = (systime - timedelta(minutes=150)).strftime("%Y-%m-%dT%H:%M:%SZ")
...
for i in vehicles:
    try:
        ...
        if rjson['count'] != 0:
            ...
            gpsMessage_filter['datetime'] = (gpsMessage_filter['timeedit']-timezone).dt.strftime("%Y-%m-%d 00:00:00")

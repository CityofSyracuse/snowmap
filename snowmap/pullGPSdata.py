...
start_date = (systime - timedelta(minutes=10080)).strftime("%Y-%m-%dT%H:%M:%SZ")
...
for i in vehicles:
    try:
        rjson = requests.get("https://api.networkfleet.com/locations/vehicle/"+i+"/track?limit=5000&with-start-date="+start_date+"&with-end-date="+end_date,
